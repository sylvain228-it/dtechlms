import { StudentContent } from '@/components/student/student-content';
import { StudentShell } from '@/components/student/student-shell';
import { StudentSidebar } from '@/components/student/student-sidebar';
import { StudentSidebarHeader } from '@/components/student/student-sidebar-header';
import { FlashData, SharedData, type BreadcrumbItem } from '@/types';
    ...
    return (
        <>
            <StudentShell variant="sidebar">
                <StudentSidebar />
                <StudentContent variant="sidebar" className="overflow-x-hidden">
