...
import { TeacherSidebarHeader } from '@/components/teacher/teacher-sidebar-header';
...
export default function TeacherSidebarLayout({
    ...
    useEffect(() => {
        ...
        // Vérifier le statut de l'upload si un upload est en cours
    ...
    return (
        <>
            <TeacherShell variant="sidebar">
                <TeacherSidebar />
                <TeacherContent variant="sidebar" className="overflow-x-hidden">
