...
import { courseNavbarHeight } from './const-shared';
...
export default function CourseContentHeaderNav({
    onMenuOpen,
}: {
    ...
    return (
        <div className="sticky top-0 right-0 left-0 z-50">
            <nav
                className={` h-[${courseNavbarHeight}] border-b border-gray-200 bg-white shadow-sm`}
            >
