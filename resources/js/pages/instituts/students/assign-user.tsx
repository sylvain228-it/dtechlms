...
export default function PartnerStudentAssignUser({
    studentId,
}: {
    studentId?: number;
}) {
    ...
    async function searchUserBySearchKey(searchKey: string) {
        try {
            ...
            const res = await fetch(
                `/dtech-partner/etudiants/api/search-user`,
                {
                    method: 'POST',
                    headers: {
    ...
    function handleAsign(e: React.FormEvent) {
        ...
        async function assignUserToStudent() {
            try {
                const res = await fetch(
                    `/dtech-partner/etudiants/api/assign-to-user`,
                    {
                        method: 'POST',
                        // csrf token
                        headers: {
    ...
    return (
        <div className="mt-6 border-t border-gray-100 pt-6">
            ...
            <p className="text-sm text-gray-600">
                Cette fonctionnalité permet d'associer ce profil étudiant à un
                compte utilisateur existant sur la plateforme.
            </p>
            <div className="mt-4">
