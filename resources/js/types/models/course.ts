...
export interface CourseActivity {
    ...
    evaluation_max_weight?: number | null; // decimal(5,2)
    note_unit?: NoteUnit;
    ...
    parent_course?: Course | null;
    resources?: EntityResource[] | null;
    deliv_requirements?: DeliverableRequirements[] | [];
...
export interface ActivitySubmission {
    ...
    title?: string | null;
    description?: string | null;
    submitted_files?: string | null; // JSON contenant chemins / URLs

    // Soumission
    submitted_at?: string | null; // ISO datetime
    nb_attempt: number; // ISO datetime
...
export interface DeliverableRequirements {
    ...
    order: number;
    title: string;
    file_type: DeliverableType | ResourceType;
    max_size_mb?: number | null; // uniquement pour type 'file'
    allowed_file_type?: string; // uniquement pour type 'file'
    // Timestamps
    created_at?: string | null; // ISO datetime
    updated_at?: string | null; // ISO datetime
}
