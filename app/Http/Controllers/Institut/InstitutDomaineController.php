...
class InstitutDomaineController extends Controller
{
    use AppUtilityTrait;
    /**
    ...
    public function index()
    {
        ...
        return inertia('instituts/domaines/index', [
            'domaines' => $domaines,
        ]);
    }
    ...
    {
        $domaines = Domaine::all();
        return inertia('instituts/domaines/create', [
            'domaines' => $domaines,
        ]);
    }
    ...
    public function store(DomaineRequest $request)
    {
        ...
        return redirect()->back()->with('success', 'Domaine créée avec succès.');
    }
    ...
    public function update(DomaineRequest $request, string $id)
    {
        ...
        return redirect()->back()->with('success', 'Domaine modifiée avec succès.');
    }
    ...
    public function destroy(string $id)
    {
        $domaine = Domaine::findOrFail($id);
        $domaine->delete();
        return redirect()->back()->with('success', 'Domaine supprimée avec succès.');
    }
}
